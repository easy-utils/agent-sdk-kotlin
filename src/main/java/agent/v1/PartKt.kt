...
public inline fun part(block: agent.v1.PartKt.Dsl.() -> kotlin.Unit): agent.v1.Part =
  agent.v1.PartKt.Dsl._create(agent.v1.Part.newBuilder()).apply { block() }._build()
/**
...
public object PartKt {
  ...
  public class Dsl private constructor(
    private val _builder: agent.v1.Part.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: agent.v1.Part.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): agent.v1.Part = _builder.build()
...
public inline fun agent.v1.Part.copy(block: `agent.v1`.PartKt.Dsl.() -> kotlin.Unit): agent.v1.Part =
