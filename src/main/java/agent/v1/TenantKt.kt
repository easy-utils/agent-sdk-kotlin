...
public inline fun tenant(block: agent.v1.TenantKt.Dsl.() -> kotlin.Unit): agent.v1.Tenant =
  agent.v1.TenantKt.Dsl._create(agent.v1.Tenant.newBuilder()).apply { block() }._build()
/**
...
public object TenantKt {
  ...
  public class Dsl private constructor(
    private val _builder: agent.v1.Tenant.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: agent.v1.Tenant.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): agent.v1.Tenant = _builder.build()
...
public inline fun agent.v1.Tenant.copy(block: `agent.v1`.TenantKt.Dsl.() -> kotlin.Unit): agent.v1.Tenant =
  `agent.v1`.TenantKt.Dsl._create(this.toBuilder()).apply { block() }._build()
