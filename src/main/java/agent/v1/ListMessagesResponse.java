...
public  final class ListMessagesResponse extends
  ...
  private com.google.protobuf.Internal.ProtobufList<agent.v1.Message> messages_;
  /**
   * <code>repeated .agent.v1.Message messages = 2 [json_name = "messages"];</code>
   */
  @java.lang.Override
  public java.util.List<agent.v1.Message> getMessagesList() {
    return messages_;
  }
  /**
   * <code>repeated .agent.v1.Message messages = 2 [json_name = "messages"];</code>
   */
  public java.util.List<? extends agent.v1.MessageOrBuilder> 
   ...
   */
  @java.lang.Override
  public agent.v1.Message getMessages(int index) {
    return messages_.get(index);
  }
  /**
   * <code>repeated .agent.v1.Message messages = 2 [json_name = "messages"];</code>
   */
  public agent.v1.MessageOrBuilder getMessagesOrBuilder(
      int index) {
    return messages_.get(index);
  }
  private void ensureMessagesIsMutable() {
    com.google.protobuf.Internal.ProtobufList<agent.v1.Message> tmp = messages_;
    if (!tmp.isModifiable()) {
      messages_ =
  ...
  private void setMessages(
      int index, agent.v1.Message value) {
   ...
   * <code>repeated .agent.v1.Message messages = 2 [json_name = "messages"];</code>
   */
  private void addMessages(agent.v1.Message value) {
    java.util.Objects.requireNonNull(value);
    ensureMessagesIsMutable();
    messages_.add(value);
  }
  ...
  private void addAllMessages(
      java.lang.Iterable<? extends agent.v1.Message> values) {
    ensureMessagesIsMutable();
  ...
  public static agent.v1.ListMessagesResponse parseFrom(
  ...
  public static agent.v1.ListMessagesResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static agent.v1.ListMessagesResponse parseFrom(java.io.InputStream input)
  ...
  public static agent.v1.ListMessagesResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }

  public static agent.v1.ListMessagesResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(agent.v1.ListMessagesResponse prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        agent.v1.ListMessagesResponse, Builder> implements
      // @@protoc_insertion_point(builder_implements:agent.v1.ListMessagesResponse)
      agent.v1.ListMessagesResponseOrBuilder {
    // Construct using agent.v1.ListMessagesResponse.newBuilder()
    private Builder() {
     ...
     */
    public Builder setMessages(
        int index, agent.v1.Message.Builder builderForValue) {
      copyOnWrite();
     ...
     * <code>repeated .agent.v1.Message messages = 2 [json_name = "messages"];</code>
     */
    public Builder addMessages(agent.v1.Message value) {
      copyOnWrite();
     ...
     */
    public Builder addMessages(
        agent.v1.Message.Builder builderForValue) {
      copyOnWrite();
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new agent.v1.ListMessagesResponse();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<agent.v1.ListMessagesResponse> parser = PARSER;
        if (parser == null) {
          synchronized (agent.v1.ListMessagesResponse.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<agent.v1.ListMessagesResponse>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final agent.v1.ListMessagesResponse DEFAULT_INSTANCE;
  static {
  ...
  public static agent.v1.ListMessagesResponse getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
