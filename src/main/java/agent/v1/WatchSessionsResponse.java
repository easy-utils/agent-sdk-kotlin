...
public  final class WatchSessionsResponse extends
  ...
  private com.google.protobuf.Internal.ProtobufList<agent.v1.Session> upserts_;
  /**
   * <code>repeated .agent.v1.Session upserts = 1 [json_name = "upserts"];</code>
   */
  @java.lang.Override
  public java.util.List<agent.v1.Session> getUpsertsList() {
    return upserts_;
  }
  /**
   * <code>repeated .agent.v1.Session upserts = 1 [json_name = "upserts"];</code>
   */
  public java.util.List<? extends agent.v1.SessionOrBuilder> 
   ...
   */
  @java.lang.Override
  public agent.v1.Session getUpserts(int index) {
    return upserts_.get(index);
  }
  /**
   * <code>repeated .agent.v1.Session upserts = 1 [json_name = "upserts"];</code>
   */
  public agent.v1.SessionOrBuilder getUpsertsOrBuilder(
      int index) {
    return upserts_.get(index);
  }
  private void ensureUpsertsIsMutable() {
    com.google.protobuf.Internal.ProtobufList<agent.v1.Session> tmp = upserts_;
    if (!tmp.isModifiable()) {
      upserts_ =
  ...
  private void setUpserts(
      int index, agent.v1.Session value) {
   ...
   * <code>repeated .agent.v1.Session upserts = 1 [json_name = "upserts"];</code>
   */
  private void addUpserts(agent.v1.Session value) {
    java.util.Objects.requireNonNull(value);
    ensureUpsertsIsMutable();
    upserts_.add(value);
  }
  ...
  private void addAllUpserts(
      java.lang.Iterable<? extends agent.v1.Session> values) {
    ensureUpsertsIsMutable();
  ...
  public static agent.v1.WatchSessionsResponse parseFrom(
  ...
  public static agent.v1.WatchSessionsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static agent.v1.WatchSessionsResponse parseFrom(java.io.InputStream input)
  ...
  public static agent.v1.WatchSessionsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }

  public static agent.v1.WatchSessionsResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(agent.v1.WatchSessionsResponse prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        agent.v1.WatchSessionsResponse, Builder> implements
      // @@protoc_insertion_point(builder_implements:agent.v1.WatchSessionsResponse)
      agent.v1.WatchSessionsResponseOrBuilder {
    // Construct using agent.v1.WatchSessionsResponse.newBuilder()
    private Builder() {
     ...
     */
    public Builder setUpserts(
        int index, agent.v1.Session.Builder builderForValue) {
      copyOnWrite();
     ...
     * <code>repeated .agent.v1.Session upserts = 1 [json_name = "upserts"];</code>
     */
    public Builder addUpserts(agent.v1.Session value) {
      copyOnWrite();
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new agent.v1.WatchSessionsResponse();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<agent.v1.WatchSessionsResponse> parser = PARSER;
        if (parser == null) {
          synchronized (agent.v1.WatchSessionsResponse.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<agent.v1.WatchSessionsResponse>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final agent.v1.WatchSessionsResponse DEFAULT_INSTANCE;
  static {
  ...
  public static agent.v1.WatchSessionsResponse getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
