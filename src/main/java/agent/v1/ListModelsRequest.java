...
public  final class ListModelsRequest extends
  ...
  public static agent.v1.ListModelsRequest parseFrom(
  ...
  public static agent.v1.ListModelsRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static agent.v1.ListModelsRequest parseFrom(java.io.InputStream input)
  ...
  public static agent.v1.ListModelsRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }

  public static agent.v1.ListModelsRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(agent.v1.ListModelsRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        agent.v1.ListModelsRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:agent.v1.ListModelsRequest)
      agent.v1.ListModelsRequestOrBuilder {
    // Construct using agent.v1.ListModelsRequest.newBuilder()
    private Builder() {
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new agent.v1.ListModelsRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<agent.v1.ListModelsRequest> parser = PARSER;
        if (parser == null) {
          synchronized (agent.v1.ListModelsRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<agent.v1.ListModelsRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final agent.v1.ListModelsRequest DEFAULT_INSTANCE;
  static {
  ...
  public static agent.v1.ListModelsRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
